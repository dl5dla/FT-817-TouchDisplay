...
*/
  ...
  _gfx->fillRoundRect(_x1, _y1, _w, _h, r/10, fill); // gesamt

// top left to right:
  _gfx->fillRoundRect(_x1, _y1, _w, 3, r/4, _gfx->intensity(150,fill) ); 
// top left down:
  _gfx->fillRoundRect(_x1, _y1, 3, _h, r/4, _gfx->intensity(150,fill) );
// from top right downwards:
  _gfx->fillRoundRect(_x1+_w-3, _y1, 3, _h, r/4, _gfx->intensity(70,fill) );
// bottom left to right:
  _gfx->fillRoundRect(_x1, _y1+_h-3, _w, 3, r/4, _gfx->intensity(70,fill) ); 
